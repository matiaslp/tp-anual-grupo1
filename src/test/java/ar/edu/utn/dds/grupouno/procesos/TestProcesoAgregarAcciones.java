...
public class TestProcesoAgregarAcciones {
	...
	public void init() {
		...
		// creamos usuario adminPrueba y le sacamos las funcionalidad
		// cambiarEstadoMail actualizacionLocalesComerciales
		...
		// creamos usuario unUsuarioTerminal1 y le sacamos las funcionalidades
		// busquedaPOI obtenerInfoPOI
	...
	// AuthAPI.getInstance().getAccion("agregarAcciones");
	// funcion.agregarAcciones(admin, tokenAdmin, 0, false, (new File
	// (".").getAbsolutePath
	...
	//
	// // Se valida que el usuario adminPrueba no tiene las funcionalidades
	// agregadas
	// Assert.assertFalse(adminPrueba.getFuncionalidad("cambiarEstadoMail")!=null);
	// Assert.assertFalse(adminPrueba.getFuncionalidad("actualizacionLocalesComerciales")!=null);
	//
	// // Se valida que el usuario unUsuarioTerminal1 no tiene la funcionalidad
	// agregada
	// Assert.assertFalse(unUsuarioTerminal1.getFuncionalidad("busquedaPOI")!=null);
	//
	// }
