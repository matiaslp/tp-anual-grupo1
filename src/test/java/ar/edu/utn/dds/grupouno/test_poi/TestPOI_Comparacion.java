...
public class TestPOI_Comparacion {
	...
	public void init() {
		...
		unBanco.setTipo(TiposPOI.BANCO); // Solo llenamos un atributo de cada
											// tipo
		...
		// No vale la pena llenar mas datos de los demas tipos porque la
		// comparacion es igual para
		// todos, con comparar 2 bancos con los atributos básicos alcanza para
		// los atributos comunes.

		// Los CGPs no tienen tipos de datos que no sean String y Long, y en
		// todos se evaluan
	...
	public void compararStringDistinto() {
		Assert.assertFalse(unBanco.compararPOI(stringDistinto));// nombre
																// distinto.
																// Sale ahi.
	}
	...
	public void compararLongDistinto() {
		Assert.assertFalse(unBanco.compararPOI(longDistinto)); // piso distinto,
																// sale ahi.
	}

	@Test
	public void compararStringNull() {
		Assert.assertFalse(unBanco.compararPOI(bancoStringNull)); // Sucursal
																	// null,
																	// sale ahi
	}
	...
	public void compararLongNull() {
		Assert.assertFalse(unBanco.compararPOI(bancoLongNull)); // piso null,
																// sale ahi
	}
