...
public class PoiService {
	...
	/*
	 * public ArrayList<POI> busquedaPois(String textoLibre,String usuario)
	 * throws JSONException, MalformedURLException, IOException,
	 * MessagingException { ArrayList<POI> list = new ArrayList<POI>(); Usuario
	 * user = DB_Usuarios.getInstance().getUsuarioByName(usuario);
	 * list=POI_ABMC.getInstance().buscar(this.getServicioAPI(), textoLibre,
	 * user.getID());
	 * 
	 * return list; }
	 */
